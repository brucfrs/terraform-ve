...
locals {
  principal =  "serviceAccount:${google_service_account.service_account.email}"
}
...
resource "google_project_iam_member" "editor" {
  project = var.project_id
  role    = var.role-editor
  member  =   local.principal
}

resource "google_project_iam_member" "service_controller" {
  project = var.project_id
  role    = var.role-service-controller
  member  =  local.principal
}
